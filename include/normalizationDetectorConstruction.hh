...
#ifndef normalizationDetectorConstruction_h
#define normalizationDetectorConstruction_h 1
...
class normalizationDetectorConstruction : public G4VUserDetectorConstruction
{
  public:
    normalizationDetectorConstruction();
    virtual ~normalizationDetectorConstruction();

  public:
    virtual G4VPhysicalVolume* Construct();
    
    void SetHeadsDimensions(G4double x,G4double y,G4double z){ headx = x;heady = y;headz = z;};
    void SetDH0Position(G4double x,G4double y,G4double z){posdh0x = x;posdh0y = y;posdh0z = z;};
...
#endif /*normalizationDetectorConstruction_h*/
